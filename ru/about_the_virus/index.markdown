...
При реализации мини-проекта с комиксами, планирую открыть кафе-магазин. По возможности, прошу поддержать мини-проект с комиксами (для реализации идеи требуется 50&nbsp;000$). Отчёт о сборах средств готов буду предоставить в любой момент.  
